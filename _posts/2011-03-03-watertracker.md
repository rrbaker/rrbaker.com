...
layout: post
title: WaterTracker
summary: Structured data, integrated response. How we're using mobiles, IVRs, and an Afghan run initiative to save money fixing wells in Afghanistan.
category: Work
...
_*The following is reposted from [the Ushahidi blog], with some minor edits.*_
